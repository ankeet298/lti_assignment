...
def read1():
    ...
    try:
        ...
        stu_dic = {}
        for j in stu:
            stu_dic[str(j)] = {"id":j.id,"name":j.name,"class_id":j.clasid, "created_on":j.creon, "updated_on":j.updon}
...
def read2():
    ...
    try:
        ...
        cls_dic = {}
        for j in cls:
            cls_dic[str(j)] = {"id":j.id,"name":j.name,"class_leader":j.clsrep, "created_on":j.creon, "updated_on":j.updon}
